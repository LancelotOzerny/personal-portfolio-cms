...
<div class="admin-panel">
    <?php (new Dev\Components\Navigation\Navigation(['dir' => '/admin/']))->show(); ?>

    <div class="admin-panel__content">
        <header>
            <div class="page-title__wrapper">
                <p class="page-title page__title page-title--normal page-title--mini"><?= Template::getInstance()->getParam('page-title') ?? 'Добро пожаловать в административную панель!' ?></p>
